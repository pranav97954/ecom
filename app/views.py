...
class checkout(View):
    def get(self,request):
        ...
        # {'id': 'order_LUyxkwgW7spxEe', 'entity': 'order', 'amount': 38500, 'amount_paid': 0, 'amount_due': 38500, 'currency': 'INR', 'receipt': 'order_rcptid_11', 'offer_id': None, 'status': 'created', 'attempts': 0, 'notes': [], 'created_at': 1679578111}
